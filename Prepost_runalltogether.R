...
## Save results
saveRDS(mod1,file="./Results/PrePost_AR.RDS")
...
## Save results
saveRDS(mod1,file="./Results/Prepost_BR.RDS")
rr.summary <- bind_rows(map(mod1 , ~.[["rr.q"]]))
rr.summary
...
## Save results
saveRDS(mod1,file="./Results/Prepost_CH.RDS")
rr.summary <- bind_rows(map(mod1 , ~.[["rr.q"]]))
rr.summary
...
## Save results
saveRDS(mod1,file="./Results/Prepost_COL.RDS")
rr.summary <- bind_rows(map(mod1 , ~.[["rr.q"]]))
rr.summary
...
## Save results
saveRDS(mod1,file="./Results/Prepost_MX.RDS")
rr.summary <- bind_rows(map(mod1 , ~.[["rr.q"]]))
rr.summary
