...
## Save results
saveRDS(mod1,file="./Results/SC_ridge_AR_offset.RDS")
...
## Save results
saveRDS(mod1,file="./Results/SC_ridge_BR.RDS")
rr.summary <- bind_rows(map(mod1 , ~.[["rr.q"]]))
rr.summary
...
## Save results
saveRDS(mod1,file="./Results/SC_ridge_CH_nooffset.RDS")
rr.summary <- bind_rows(map(mod1 , ~.[["rr.q"]]))
rr.summary
...
## Save results
saveRDS(mod1,file="./Results/SC_ridge_COL_nooffset.RDS")
rr.summary <- bind_rows(map(mod1 , ~.[["rr.q"]]))
rr.summary
...
## Save results
saveRDS(mod1,file="./Results/SC_ridge_MX_nooffset.RDS")
rr.summary <- bind_rows(map(mod1 , ~.[["rr.q"]]))
rr.summary
