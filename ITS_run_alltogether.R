...
mod1<-pblapply(cl = cl,X=ds.age.spl,FUN=data_prep_model_ITS)
stopCluster(cl)

## Save results
saveRDS(mod1,file="./Results/ITS_AR.RDS")
...
## Save results
saveRDS(mod1,file="./Results/ITS_BR.RDS")
rr.summary <- bind_rows(map(mod1 , ~.[["rr.q"]]))
rr.summary
...
## Save results
saveRDS(mod1,file="./Results/ITS_CH.RDS")
rr.summary <- bind_rows(map(mod1 , ~.[["rr.q"]]))
rr.summary
...
## Save results
saveRDS(mod1,file="./Results/ITS_COL.RDS")
rr.summary <- bind_rows(map(mod1 , ~.[["rr.q"]]))
rr.summary
...
## Save results
saveRDS(mod1,file="./Results/ITS_MX.RDS")
rr.summary <- bind_rows(map(mod1 , ~.[["rr.q"]]))
rr.summary
